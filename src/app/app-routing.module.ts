  ...
  {path: 'error', loadChildren: () => import('./views/pages/error/error.module').then(m => m.ErrorModule)},
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('./views/pages/wifi-management/wifi-management.module').then(m => m.WifiManagementModule),
      },
      {
        path: 'usb-management',
        loadChildren: () => import('./views/pages/usb-management/usb-management.module').then(m => m.UsbManagementModule),
      },
      {
        path: 'wizard',
