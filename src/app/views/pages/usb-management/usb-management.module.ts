...
// Components
import { UsbManagementComponent } from './usb-management.component';
...
//import { DetailsDialogComponent } from './users/details-dialog/details-dialog.component';
import { UsbListComponent } from './list/usb-list.component';
import { DetailsDialogComponent } from './details-dialog/details-dialog.component';

const routes: Routes = [
	{
		path: '',
		component: UsbManagementComponent,
		children: [
			{
				path: '',
				redirectTo: '',
...
@NgModule({
	...
	declarations: [
		UsbManagementComponent,
    UsbListComponent,
    DetailsDialogComponent
	]
})
export class UsbManagementModule {}
